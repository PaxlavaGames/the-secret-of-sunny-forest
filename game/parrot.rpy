label parrot:
    ...
    v "Я понял, что я не своем мире, когда увидел вдалеке людей и собак, у нас в мире нет людей и больших животных. Но я читал  о них в древних преданиях"
    $ is_one_answer = False
...
label manywords:
    ...
    v "Девушки, эта картина нам поможет найти портал, только при перемещении она порвалась"
