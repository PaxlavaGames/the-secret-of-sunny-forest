label note:
    ...
    v "На обороте картины мы найдем рецепт зелья, которое откроет нам глаза на магию в вашем мире"
    v "И так мы увидим портал"
    # убрать здесь пазл
    ...
    menu:
        ...
        "Перевернуть картину и посмотреть, что на обороте":
            ...
            if is_with_swimm:
                p "А я видела голубые водоросли, когда плавала в маске"
            else:
                p "Надо было плавать в маске, тогда бы я разглядела все дно"
